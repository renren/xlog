...
public abstract class XlogClient {
	...
	protected BlockingQueue<LogData[]> logDataBQ = null;
	...
	public abstract void initialize(String cacheFileDir,int cacheQueueSize,ProtocolType pt) throws InitializationException;
	...
	//protected abstract void initialize(Properties prop) throws InitializationException;
